...
namespace PokemonAPI.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PokemonOwners_PokemonCategories_PokemonCategoryPokemonId_PokemonCategoryCategoryId",
                        columns: x => new { x.PokemonCategoryPokemonId, x.PokemonCategoryCategoryId },
                        principalTable: "PokemonCategories",
                        principalColumns: new[] { "PokemonId", "CategoryId" });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PokemonOwners_PokemonCategoryPokemonId_PokemonCategoryCategoryId",
                table: "PokemonOwners",
                columns: new[] { "PokemonCategoryPokemonId", "PokemonCategoryCategoryId" });
